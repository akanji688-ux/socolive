...
function renderButtons(buttons, page) {
  ...
  buttons.forEach(b => {
    ...
    if (b.color) { a.style.background = b.color; a.style.borderColor = b.color; a.style.color = b.textColor || '#0a1628'; a.style.textDecoration = 'none'; } else if (b.textColor) { a.style.color = b.textColor; }
    if (b.badge) {
